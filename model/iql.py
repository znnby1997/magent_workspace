...
from utils.experience_memory import ExperienceMemory, Dynamics
...
class IQL(object):
    def __init__(self, obs_dim, n_actions, net, agent_num, gamma=0.98, batch_size=5000,
                capacity=100000, lr=6e-4, hidden_dim=32):
        self.gamma = gamma
    ...
    def learn(self):
        ...
        obs, action, reward, next_obs, done = self.sample()
        ...
        # print('qa_values shape: ', qa_values.shape, ' q_target shape: ', q_target.shape)
